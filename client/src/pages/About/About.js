...
const About = () => {
  return (
    ...
    <div className="about-us-content">
      ...
      <p>
        At <strong>ShopNow</strong>, we are passionate about delivering the best shopping experience to our customers. Our mission is to provide you with high-quality products, excellent customer service, and a seamless online shopping journey.
      </p>
      <h2>Who We Are</h2>
      <p>
        <strong>ShopNow</strong> is a leading online retailer, specializing in [mention the types of products you sell, e.g., electronics, fashion, home decor, etc.]. We take pride in offering a wide range of products from top brands, ensuring that you have access to the latest trends and top-notch quality.
      </p>
      ...
      <h2>Get In Touch</h2>
      <p>
        Thank you for choosing <strong>ShopNow</strong>. We appreciate your trust and look forward to serving you. If you have any inquiries, feedback, or just want to say hello, feel free to contact us through our customer support or email. Happy shopping!
      </p>
